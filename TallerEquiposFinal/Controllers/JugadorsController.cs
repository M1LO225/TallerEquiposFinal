...
namespace TallerEquiposFinal.Controllers
{
    public class JugadorsController : Controller
    {
        ...
        public JugadorsController(TallerEquiposFinalContext context)
        {
            _context = context;
        }
        ...
        {
            var tallerEquiposFinalContext = _context.Jugador.Include(j => j.Equipo);
        ...
        {
            ViewData["IdEquipo"] = new SelectList(_context.Equipo, "IdEquipo", "NombreEquipo");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdJugador,NombreJugador,Posicion,Edad,IdEquipo")] Jugador jugador)
        {
            ...
            ViewData["IdEquipo"] = new SelectList(_context.Equipo, "IdEquipo", "NombreEquipo", jugador.IdEquipo);
            return View(jugador);
        }
